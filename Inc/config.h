...
*/
  ...
  #define PRI_INPUT1            2, 0, 0, 4095, 100      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            2, 0, 0, 4095, 100      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
