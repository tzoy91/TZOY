...
#define FIELD_WEAK_HI   1900            // (1000, 1500] Input target High threshold for reaching maximum Field Weakening / Phase Advance. Do NOT set this higher than 1500.
#define FIELD_WEAK_LO   1500             // ( 500, 1000] Input target Low threshold for starting Field Weakening / Phase Advance. Do NOT set this higher than 1000.
...
*/
  ...
  #define PRI_INPUT1            3, 100, 2000, 4095, 100      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #define FEEDBACK_SERIAL_USART3       cfprot     // Tx to   right sensor board: for LED battery indication. Comment-out if sideboard is not used!
  ...
  #define PRI_INPUT2              3,   500, 0, 2100, 0  // Pedal Accel        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
